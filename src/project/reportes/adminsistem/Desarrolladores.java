 ...
 * @author fabricio
 */
public class Desarrolladores extends javax.swing.JInternalFrame {

    private BaseDatos DB = null;
    private List<Usuario> listaUsuarios = null;
    private ObservableList<Usuario> listaUsurObsr = null;
    
    /**
     * Creates new form Desarrolladores
     */
    public Desarrolladores(BaseDatos DB) {
        this.DB = DB;
        this.listaUsuarios = new LinkedList<>();
        this.listaUsurObsr = ObservableCollections.observableList(listaUsuarios);
        initComponents();
        actualizarUsuarios();
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${listaUsurObsr}");
    ...
    private void buttonTodo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonTodo1ActionPerformed
        ...
        mr.exportarHtmlDesarrolladores(exportador.getFile(), listaUsurObsr);
    ...
    private void actualizarUsuarios(){
        ...
        if(mu.getUsuarioByTipo("3") != null){
            listaUsurObsr.addAll(mu.getUsuarioByTipo("3"));
        }
    }
    
    public ObservableList<Usuario> getListaUsurObsr() {
        return listaUsurObsr;
    }

    public void setListaUsurObsr(ObservableList<Usuario> listaUsurObsr) {
        this.listaUsurObsr = listaUsurObsr;
    }
